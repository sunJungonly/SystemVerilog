...
set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports { rs_btn }]; #IO_L17N_T2_A13_D29_14 ,Sch=BTNU
set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { sw_m_btn }]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports { ud_w_btn }]; #IO_L17P_T2_A14_D30_14 ,Sch=BTNR
set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { c_btn }]; #IO_L18P_T2_A12_D28_14 ,Sch=BTND
