...
module DataPath (
    ...
    logic [31:0] DecReg_RFData1, DecReg_RFData2, DecReg_immExt, ExeReg_RFData2, ExeReg_aluResult, ExeReg_PCSrcMuxOut, MemAccReg_dataRData;
