...
module DataPath (
    ...
    logic [31:0] PC_Imm_AdderResult, PC_4_AdderResult, PCSrcMuxOut, RFWData;
    ...
    s_byte_half U_S_Data_Byte_Half (
        .instrCode(instrCode),
        .RFData2(RFData2),
        .dataRData(dataRData),
        .dataWData(dataWData)
    ...
    L_byte_half U_L_Data_Byte_Half (
        .instrCode(instrCode),
        .dataRData(dataRData),
        .RFWData(RFWData)
    );
...
module L_byte_half (
    ...
    always_comb begin        
        if(instrCode[14:12] == 3'b000 | instrCode[14:12] == 3'b001 | instrCode[14:12] == 3'b010)
            RFWData =
            (instrCode[14:12] == 3'b000) ? {{24{dataRData[7]}}, dataRData[7:0]} :
            (instrCode[14:12] == 3'b001) ? {{16{dataRData[15]}}, dataRData[15:0]} : dataRData;
        else 
            RFWData =
            (instrCode[14:12] == 3'b100) ? {{24'd0}, dataRData[7:0]} :
            (instrCode[14:12] == 3'b101) ? {{16'd0}, dataRData[15:0]} : dataRData;
    end
endmodule
...
module s_byte_half (
  ...
  always_comb begin 
    if (instrCode[14:12] == 3'b000) dataWData = {dataRData[31:8], RFData2[7:0]};
    else if (instrCode[14:12] == 3'b001) dataWData = {dataRData[31:16], RFData2[15:0]};
    else dataWData = RFData2;
  end  
