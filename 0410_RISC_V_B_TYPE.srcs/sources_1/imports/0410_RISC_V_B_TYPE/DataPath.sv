...
module DataPath (
    ...
    input  logic        branch,
    input  logic        ImmAluMuxSel,
    input  logic        RegImmPCSrcMuxSel,
    input  logic        pc4RegImmSrcMuxSel,
    ...
    logic btaken, PCSrcMuxSel, ALMuxsel;
    assign PCSrcMuxSel  = btaken & branch;

    assign JALMuxsel    = pc4RegImmSrcMuxSel | PCSrcMuxSel;
    ...
    mux_2x1 U_RegImmPCSrcMux (
        .sel(RegImmPCSrcMuxSel),
        .x0 (ImmAluMuxOut),
        .x1 (PC_Imm_AdderResult),
        .y  (RegImmPCSrcMuxOut)
    );

    mux_2x1 U_Pc4RegImmSrcMux (
        .sel(pc4RegImmSrcMuxSel),
        .x0 (RegImmPCSrcMuxOut),
        .x1 (PC_4_AdderResult),
        .y  (pc4RegImmSrcMuxOut)
    );
