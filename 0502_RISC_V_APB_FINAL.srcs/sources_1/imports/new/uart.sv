...
//    output logic        TX
    ...
    logic full, empty, rx_busy, rx_done, wr_en, rd_en; //, tx_done, fifo_tx_empty;
...
module uart (
    ...
    baudrate_gen_rx U_BaudRate_Gen_RX (
        .clk    (clk),
        .reset  (reset),
        .br_tick(br_tick)
    );
...
module baudrate_gen_rx (
    ...
    logic [9:0] br_counter;  //clog2(100_000_000 / 115200 / 16) 
    ...
    always_ff @(posedge clk, posedge reset) begin
        if (reset) begin
            ...
            if (br_counter == (100_000_000 / 9600 / 16) - 1) begin  // 115200 bps
                br_counter <= 0;
                br_tick <= 1'b1;
            end else begin
